...
* **Asociación de Centro de Distribución (CD):** Definir si una tienda pertenece fijamente a un CD específico o si la relación se gestiona dinámicamente en la HU de logística/rutas.
